      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Manage API access credentials for this organization.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                This key grants full access to the DocuMesh API.
              </p>
            </div>
            <div className="border-t pt-4">
              ...
              <p className="text-xs text-muted-foreground mt-2">
                Rotating the key will immediately invalidate the old one.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure IP allowlist (CIDR notation) for restricted access.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <UpdateIpsForm
              orgId={org.id}
              initialIps={org.allowedIps as string[]}
            />
          </CardContent>
        </Card>
      </div>
